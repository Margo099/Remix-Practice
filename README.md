...
### 4. 🎁 Система Пожертвований (DonationEventLog)
...
**Фронтенд реализация на HardHat**

Фронтенд для взаимодействия с контрактом [DonationEventLog](https://github.com/Margo099/Remix-Practice/blob/main/my-dapp-frontend/src/DonationApp.jsx) реализован на **React + Vite** с использованием **ethers.js**.

### 🔧 Основной функционал:

- 🔗 Подключение MetaMask
- 💸 Отправка донатов с сообщением (в ETH)
- 📜 Просмотр истории всех донатов (адрес, сумма, сообщение, время)
- 🧮 Отображение баланса контракта
- 🔐 Вывод средств владельцем контракта

### 🛠️ Используемые технологии:

- `React` (хуки, состояние компонентов)
- `ethers.js` — для взаимодействия с контрактом
- `MetaMask` — провайдер аккаунта пользователя
- `Vite` — для быстрого запуска проекта
- `CSS` — базовая стилизация

### 🚀 Запуск проекта локально:

1. Убедитесь, что запущена локальная сеть (например, Hardhat)
2. Убедитесь, что MetaMask подключён к правильной сети
